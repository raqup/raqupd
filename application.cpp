...
void Application::formatNumber( char *buffer, float value ) {
  char                unit = 'K';
...
Application::Application( const char* device, const unsigned int delay ) : cobalt( device ), interface( "eth0" ) {
  this->delay = delay;
...
void Application::print( const char *line1, const char *line2, const unsigned int delay ) {
...
enum Application::Screen Application::sysInfo( enum Screen previous, enum Screen next ) {
  char  line1[ 80 ],
        line2[ 80 ],
...
enum Application::Screen Application::cpuInfo( enum Screen previous, enum Screen next ) {
...
enum Application::Screen Application::memInfo( enum Screen previous, enum Screen next ) {
  float in, out;
  long  dummy,
...
enum Application::Screen Application::loadInfo( enum Screen previous, enum Screen next ) {
  float l1, l5, l10;
  char  line2[ 17 ];
...
enum Application::Screen Application::uptimeInfo( enum Screen previous, enum Screen next ) {
    float s;
...
enum Application::Screen Application::menuItem( const char *line1, const char *line2, enum Screen next, enum Screen select ) {
...
int Application::request( const char *question, const char *option1, const char *option2, const int defaultOption ) {
  char  line1[ 32 ] = "",
        line2[ 32 ] = "",
...
const char* Application::editIP( const char *line1, const char *address ) {
  int           digit,
                ip[ 4 ],
                mul = 1;
  char          cursor = 0;
...
void Application::configServices() {
